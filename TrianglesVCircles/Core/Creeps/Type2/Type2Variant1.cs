...
{
    public class Type2Variant1 : BaseEnemy
    {
        public Type2Variant1(string question, string answer,
            IAttackable target, IMoveStrategy moveStrategy)
            : base(question, answer, target, moveStrategy)
        {
        }
        public Type2Variant1(string life,
            IAttackable target, IMoveStrategy moveStrategy)
            : base(life, target, moveStrategy)
        {
        }

        public Type2Variant1(IEnumerable<string> life,
            IAttackable target, IMoveStrategy moveStrategy)
            : base(life, target, moveStrategy)
        {
        }

        public Type2Variant1(char life, IAttackable target,
        ...
        protected override BaseAttack InitializeAttack()
        {
            ...
            {
                AttackSpeed = TimeSpan.FromMilliseconds(9200),
