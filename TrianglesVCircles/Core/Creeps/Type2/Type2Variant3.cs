...
{
    public class Type2Variant3 : BaseEnemy
    {
        public Type2Variant3(string question, string answer,
            IAttackable target, IMoveStrategy moveStrategy)
            : base(question, answer, target, moveStrategy)
        {
        }

        public Type2Variant3(IEnumerable<string> life, IAttackable target,
            IMoveStrategy moveStrategy) 
            : base(life, target, moveStrategy) { }

        public Type2Variant3(char life, IAttackable target,
            IMoveStrategy moveStrategy) 
            : base(life, target, moveStrategy) { }
        ...
        protected override BaseAttack InitializeAttack()
        {
            return new SingleArc(this, Target)
            {
                ...
                AttackSpeed = TimeSpan.FromMilliseconds(8600),
            };
        }
    }
}
