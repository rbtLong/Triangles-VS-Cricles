...
{
    public class Type1Variant1 : BaseEnemy
    {
        public Type1Variant1(string question, string answer,
            IAttackable target, IMoveStrategy moveStrategy)
            : base(question, answer, target, moveStrategy)
        {
        }

        public Type1Variant1(string life,
            IAttackable target, IMoveStrategy moveStrategy)
            : base(life, target, moveStrategy)
        {
        }

        public Type1Variant1(IEnumerable<string> life, 
            IAttackable target, IMoveStrategy moveStrategy)
            : base(life, target, moveStrategy) { }
        public Type1Variant1(char life, IAttackable target,
        ...
        protected override BaseAttack InitializeAttack()
        {
            ...
            {
                SingleAttack = false,
                Frequency = TimeSpan.FromMilliseconds(900),
                AttackSpeed = TimeSpan.FromMilliseconds(22000)
            };
        }
