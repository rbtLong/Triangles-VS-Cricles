...
namespace TrianglesVCircles.Helpers
	{
	public abstract class ObservableImmutableListObject : INotifyCollectionChanged, INotifyPropertyChanged
		{
		#region Private
		...
		protected ObservableImmutableListObject(LockTypeEnum lockType)
			{
			_lockType = lockType;
			_lockObj = new object();
			}
