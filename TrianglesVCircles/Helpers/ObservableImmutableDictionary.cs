...
namespace TrianglesVCircles.Helpers
	{
	public class ObservableImmutableDictionary<T, V> : ObservableImmutableListObject, IImmutableDictionary<T, V>, IReadOnlyDictionary<T, V>, IReadOnlyCollection<KeyValuePair<T, V>>, IDictionary<T, V>, ICollection<KeyValuePair<T, V>>, IEnumerable<KeyValuePair<T, V>>, IDictionary, INotifyCollectionChanged, INotifyPropertyChanged
		{
		#region Private
